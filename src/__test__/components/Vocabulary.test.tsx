...
import {
  subjectTest5, quadWithIsDefinedBy, quadWithTypeClassOwl, quadWithTypeClassRdfs, quadWithTypeToPropertyRdf,
  quadWithTypeToDatatypeProperty, quadWithTypeToObjectProperty,
} from '../TestData';
